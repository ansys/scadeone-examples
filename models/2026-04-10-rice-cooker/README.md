...
- open the Rapid Prototyper graphical panels project at RiceCookerGraphicalPanels\RiceCookerGraphicalPanels.etp`,
- open each of the two graphical specifications inside: `RiceCookerPanel` and `VisualizationPanel`,
- for each specification, launch the `ScadeOneCoSimulation` job.

This generates two Scade One wrapper projects that the main project depends on.

Once this is done, you may open the main Scade One project: `RiceCookerController/RiceCookerController.sproj`.
...
- simulation harnesses connect both sides together for batch simulation or interactive debug.
...
File: `RiceCookerController/assets/Controller.swan`
...
- `RiceCookerController/assets/Clock-Ticks.swan`
- `RiceCookerController/assets/Clock-Utils.swan`
- `RiceCookerController/assets/Utils-Msg.swan`
- `RiceCookerController/assets/Utils-Msg.swani`
- `RiceCookerController/assets/Utils-PIController.swan`
...
File: `RiceCookerController/assets/PlantModel.swan`
...
Rapid Prototyper Project: `RiceCookerGraphicalPanels\RiceCookerGraphicalPanels.etp`
...
- `RiceCookerPanel/assets/RiceCookerPanel.swan`
- `VisualizationPanel/assets/VisualizationPanel.swan`

To generate these projects, open each panel in Rapid Prototyper, then launch the `ScadeOneCoSimulation` job.

### Generate the panel

1. Select one of the graphical panel in the project view on the left.
2. Click the **Generate** button next to generator configuration `ScadeOneCosimulation`.
3. The panel is generated in a sub-folder of the Scade One model, under `RiceCookerController/<PanelName>`.
4. Repeat with the other graphical panel.
