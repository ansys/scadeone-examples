...
The main project to open is `RiceCookerController/RiceCookerController.sproj`.
...
Rapid Prototyper Project: `RiceCookerPanel\RiceCookerPanel.etp`
...
The corresponding built panels are accessible through wrapper operators in the main project:

- `RiceCookerController/RiceCookerPanel/assets/RiceCookerPanel.swan`
- `RiceCookerController/VisualizationPanel/assets/VisualizationPanel.swan`
